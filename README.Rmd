...
### Download CEF data
To download all three CEF hierarchies (work will be done to update the filter names) "HNI", "HEN", "HSN", which consist of the four record types/tables CN, DN, SN and EN in one gone please see the example below:
